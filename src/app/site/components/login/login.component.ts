    ...
    template: `
      <div [ngClass]="customStyle">
        ...
        <form (ngSubmit)="login()">
          <div class="form-group">
            ...
            <input class="form-control" id="loginNameInput" name="name" 
                placeholder="Username or email" [(ngModel)]="nameInput">
          </div>
          <div class="form-group label-floating">
            ...
            <input class="form-control" id="loginPasswordInput" name="password" 
                type="password" placeholder="Password" [(ngModel)]="passwordInput">
          </div>
        ...
        <div class="goToRegister">
          ...
          Si aún no tiene cuenta haga click <a routerLink="/register">aquí</a></p>
        </div>       
      </div>
    `
  })
